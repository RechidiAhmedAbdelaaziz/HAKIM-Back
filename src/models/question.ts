...
const schema = new Schema(
	{
		...
		questioner: { type: Schema.Types.ObjectId, ref: AppModels.user, required: true },
...
const schema2 = new Schema(
	{
		question: { type: Schema.Types.ObjectId, ref: AppModels.question, required: true },
		answer: { type: String, required: true },
		respondent: { type: Schema.Types.ObjectId, ref: AppModels.user, required: true },
	},
	{ timestamps: true }
);
